...
graph TD
    ...
    C -->|3. Approve or Reject| C
    C -->|4. Approved| D[Receptionist Check-In]
    D -->|5. Physical Pass Issued| A
    A -->|6. Visit Concludes| E[Receptionist Check-Out]
    E -->|7. Audit Logged| F[Admin Dashboard & Reports]
```
